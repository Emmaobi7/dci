...
const CourseLearning = ({ course, onBack }) => {
  ...
  const getYouTubeEmbedUrl = (url) => {
    if (!url) return '';
    try {
      // Handle search queries generated by AI
                    ...
                    {activeLesson ? (
                      <div className="bg-gray-800 rounded-xl overflow-hidden border border-gray-700">
                        <div className="aspect-video bg-black flex items-center justify-center relative">
                          ...
                          {activeLesson.type === 'video' && activeLesson.content ? (
                              ...
                              <>
                                ...
                                <div className="absolute top-4 right-4 z-10">
                                  <a
                                    ...
                                    className="bg-black/60 hover:bg-black/80 text-white px-3 py-2 rounded-lg backdrop-blur-sm transition text-xs flex items-center gap-2 border border-white/10"
                                    title="Open video in new tab if it fails to load"
                                  >
                          ...
                          ) : ['text', 'article', 'quiz', 'assignment'].includes(activeLesson.type) ? (
                            <div className="text-center p-8">
                              <FaExternalLinkAlt className="text-6xl mx-auto mb-4 text-teal-500" />
                              <h3 className="text-xl font-bold text-white mb-2 uppercase">{activeLesson.type} CONTENT</h3>
                              <a
                                href={activeLesson.content}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center space-x-2 bg-teal-500 hover:bg-teal-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition-colors mt-2"
                              >
                                <span>OPEN {activeLesson.type.toUpperCase()}</span>
                                <FaExternalLinkAlt />
                              </a>
                            ...
                            <div className="text-gray-500 text-center p-8">
                              <FaRecordVinyl className="text-4xl mx-auto mb-4 opacity-50" />
